...
module.exports = (client, message, args, prefix, welcome) => {
    ...
    if (message.guild.channels.get(welcome.welcome._id)) {
       canalWelcome = `${client.getEmoji("oni")} Ativo | Canal: <#${welcome.welcome._id}>, ${prefix}welcome off`;
    }
    ...
    if (message.guild.channels.get(welcome.saida._id)) {
        canalSaida = `${client.getEmoji("oni")} Ativo | Canal: <#${welcome.saida._id}>, ${prefix}welcome saida off`;
    }
